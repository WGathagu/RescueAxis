...
public class ExpandableListViewAdapterOthers extends BaseExpandableListAdapter {
    ...
    public ExpandableListViewAdapterOthers(Context context, List<String> childParent, HashMap<String, List<String>> child) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(view == null){
            ...
            view = inflater.inflate(R.layout.greeting_parent_layout, parent, false);
        ...
        TextView parentItem = (TextView)view.findViewById(R.id.greetparent_layout);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if(view == null){
            ...
            view = inflater.inflate(R.layout.greeting_child_layout, parent, false);

        }

        String childName = (String)getChild(groupPosition, childPosition);

        TextView childItem = (TextView)view.findViewById(R.id.greetchild_layout);
